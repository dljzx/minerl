...
class BasaltBaseEnvSpec(HumanControlEnvSpec):
    ...
    def __init__(
        ...
        self.initial_inventory = initial_inventory  # Used by minerl.util.docs to construct Sphinx docs.
        self.mobs = mobs
        self.blocks = blocks
...
class Summontest(BasaltBaseEnvSpec):
    ...
    def __init__(self, initial_inventory):
        super().__init__(
            ...
            preferred_spawn_biome="flower_plains",
...
def make_env(task_id: str):
    ...
    inventory = task_specs['initial_inventory']
    print(inventory)
    env = gym.make('Summontest-v0')

if __name__ == '__main__':
    make_env('custom_combat_8')
